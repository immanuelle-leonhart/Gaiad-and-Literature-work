...
namespace StarLib
{
...
#endif
    {
        ...
        //
        // StarCompareInfos have an interesting identity.  They are attached to the locale that created them,
        ...
        private String m_name;  // The name used to construct this StarCompareInfo
        ...
        ////////////////////////////////////////////////////////////////////////
        //
        //  StarCompareInfo Constructor
        //
        //
        ////////////////////////////////////////////////////////////////////////
        // Constructs an instance that most closely corresponds to the NLS locale
        // identifier.
        internal StarCompareInfo(StarCulture culture)
        {
        ...
        **Returns: The StarCompareInfo for the specified culture.
        **Arguments:
        ...
        **  ArgumentException if culture is invalid.
...
#if FEATURE_USE_LCID
        // 
        public static StarCompareInfo GetStarCompareInfo(int culture, Assembly assembly){
            // Parameter checking.
            if (assembly == null) {
            ...
            return GetStarCompareInfo(culture);
        }
#endif
        ...
        /*=================================GetStarCompareInfo==========================
        **Action: Get the StarCompareInfo constructed from the data table in the specified assembly for the specified culture.
        **       The purpose of this method is to provide version for StarCompareInfo tables.
        **Returns: The StarCompareInfo for the specified culture.
        **Arguments:
        ...
        **  ArgumentException if name is invalid.
        ============================================================================*/
        // 
        public static StarCompareInfo GetStarCompareInfo(String name, Assembly assembly)
        {
        ...
        /*=================================GetStarCompareInfo==========================
        **Action: Get the StarCompareInfo for the specified culture.
        ...
        **  ArgumentException if culture is invalid.
        ...
        public static StarCompareInfo GetStarCompareInfo(int culture)
        {
            ...
            return StarCulture.GetStarCulture(culture).StarCompareInfo;
        }
#endif
        ...
        **  ArgumentException if name is invalid.
        ...
        public static StarCompareInfo GetStarCompareInfo(String name)
        {
            if (name == null)
            {
        ...
        private void OnDeserialized()
        {
            ...
            if (this.m_name == null)
            {
                ...
                ci = StarCulture.GetStarCulture(this.culture);
                this.m_name = ci.m_name;
            }
            else
            {
                ci = StarCulture.GetStarCulture(m_name);
            }
        ...
        private void OnSerializing(StreamingContext ctx)
        {
            ...
            culture = StarCulture.GetStarCulture(this.Name).LCID; // This is the lcid of the constructing culture (still have to dereference to get target sort)
            Contract.Assert(m_name != null, "StarCompareInfo.OnSerializing - expected m_name to be set already");
        }
        ...
        //  what the sort is.
        //
        //  Note that this name isn't dereferenced in case the StarCompareInfo is a different locale
        ...
        public virtual String Name
        {
            get
            {
                Contract.Assert(m_name != null, "StarCompareInfo.Name Expected m_name to be set");
        ...
        internal static int GetNativeCompareFlags(CompareOptions options)
        {
            ...
            // 
            Contract.Assert(options != CompareOptions.OrdinalIgnoreCase, "[StarCompareInfo.GetNativeCompareFlags]CompareOptions.OrdinalIgnoreCase should be handled separately");
            ...
            Contract.Assert(((options & ~(CompareOptions.IgnoreCase |
                             ...
                             (options == CompareOptions.Ordinal), "[StarCompareInfo.GetNativeCompareFlags]Expected all flags to be handled");

            Contract.Assert((nativeCompareFlags & RESERVED_FIND_ASCII_STRING) == 0, "[StarCompareInfo.GetNativeCompareFlags] RESERVED_FIND_ASCII_STRING shouldn't be set here");
        ...
        public unsafe virtual int IndexOf(String source, char value, int startIndex, int count, CompareOptions options)
        {
            ...
            if ((options & ValidIndexMaskOffFlags) != 0 && (options != CompareOptions.Ordinal))
                throw new ArgumentOutOfRangeException();//(Environment.GetResourceString("Argument_InvalidFlag"), "options");
...
//#endif // !FEATURE_PAL
        ...
        //  or not object refers to the same StarCompareInfo as the current
        //  instance.
        //
        ////////////////////////////////////////////////////////////////////////
        ...
        {
            StarCompareInfo that = value as StarCompareInfo;
        ...
        //  StarCompareInfo.  The hash code is guaranteed to be the same for
        //  StarCompareInfo A and B where A.Equals(B) is true.
        //
        ////////////////////////////////////////////////////////////////////////
        ...
        public virtual int GetHashCode(string source, CompareOptions options)
        {
            ...
            if (options == CompareOptions.OrdinalIgnoreCase)
            {
                throw new NotImplementedException();// return TextInfo.GetHashCodeOrdinalIgnoreCase(source);
            }
        ...
        //  string from StarCompareInfo, and generate a hashcode value from it.  It is not very convenient
        ...
        //  the StarCompareInfo and the CompareOptions are the same. If two different StarCompareInfo objects
        ...
        //
        //      string.GetHashCode(StarCulture)
        //      string.GetHashCode(StarCompareInfo)
        //      string.GetHashCode(StarCulture, CompareOptions)
        //      string.GetHashCode(StarCompareInfo, CompareOptions)
        //      etc.
        //
        //  (the methods above that take a StarCulture would use StarCulture.StarCompareInfo)
        //
        ////////////////////////////////////////////////////////////////////////
        ...
        public int LCID
        {
            get
            {
                return StarCulture.GetStarCulture(this.Name).LCID;
            }
        }
#endif
