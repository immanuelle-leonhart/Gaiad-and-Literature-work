////////////////////////////////////////////////////////////////////////////
//
// StarDateFormatInfoScanner
//
//  Scan a specified StarCulture to search for data used in StarDate.Parse()
//
//  The data includes:
//
...
namespace StarLib
{
    ...
    internal class StarDateFormatInfoScanner
    {
        ...
        // "." as ignorable symbol so that the StarDate.Parse() state machine will not
