...
namespace StarCalendar
{
    ...
    // for a specific StarDateFormatInfo instance.
    ...
    public sealed class StarDateFormatInfo : ICloneable, IFormatProvider
    {
        //
        ...
        private static volatile StarDateFormatInfo invariantInfo;
        ...
        // Cache the era names for this StarDateFormatInfo instance.
        ...
        //
        // Invariant StarDateFormatInfo doesn't have user-overriden values
        // Default calendar is gregorian
        public StarDateFormatInfo()
            //: this(CultureInfo.InvariantCulture.m_cultureData,
            //        GregorianCalendar.GetDefaultInstance())
        {
        }

        internal StarDateFormatInfo(CultureInfo cultureData, Calendar cal)
        {
        ...
        private void InitializeOverridableProperties(CultureInfo cultureData, int calendarID)
        {
            ...
            Contract.Requires(cultureData != null);
            Contract.Assert(calendarID > 0, "[StarDateFormatInfo.Populate] Expected Calendar.ID > 0");
            ...
            Contract.Assert(this.allLongDatePatterns.Length > 0, "[StarDateFormatInfo.Populate] Expected some long date patterns");

            this.allShortDatePatterns = cultureData.ShortDates(calendarID);
            Contract.Assert(this.allShortDatePatterns.Length > 0, "[StarDateFormatInfo.Populate] Expected some short date patterns");

            this.allYearMonthPatterns = cultureData.YearMonths(calendarID);
            Contract.Assert(this.allYearMonthPatterns.Length > 0, "[StarDateFormatInfo.Populate] Expected some year month patterns");
#endif
        }
        ...
        // Returns a default StarDateFormatInfo that will be universally
        // supported and constant irrespective of the current culture.
        // Used by FromString methods.
        //

        public static StarDateFormatInfo InvariantInfo
        {
            get
            {
                ...
                {
                    StarDateFormatInfo info = new StarDateFormatInfo();
        ...
        // Returns the current culture's StarDateFormatInfo.  Used by Parse methods.
        //

        public static StarDateFormatInfo CurrentInfo
        {
            get
            {
                ...
                {
                    StarDateFormatInfo info = culture.StarDateInfo;
                    if (info != null)
                    {
                        return info;
                    }
                }
                return (StarDateFormatInfo)culture.GetFormat(typeof(StarDateFormatInfo));
            }
        }


        public static StarDateFormatInfo GetInstance(IFormatProvider provider)
        {
            // Fast case for a regular CultureInfo
            StarDateFormatInfo info;
            ...
            info = provider as StarDateFormatInfo;
            if (info != null)
            {
                return info;
            }
            ...
            if (provider != null)
            {
                info = provider.GetFormat(typeof(StarDateFormatInfo)) as StarDateFormatInfo;
                if (info != null)
                {
                    return info;
                }
        ...
        {
            return (formatType == typeof(StarDateFormatInfo) ? this : null);
        }


        public Object Clone()
        {
            StarDateFormatInfo n = (StarDateFormatInfo)MemberwiseClone();
...
#endif
                Contract.Assert(this.amDesignator != null, "StarDateFormatInfo.AMDesignator, amDesignator != null");
        ...
        **      ArguementException if the era valie is invalid.
        ...
        //        {
        //            Contract.Assert(Calendar.ID > 0, "[StarDateFormatInfo.AbbreviatedEnglishEraNames] Expected Calendar.ID > 0");
...
#endif
                Contract.Assert(this.firstDayOfWeek != -1, "StarDateFormatInfo.FirstDayOfWeek, firstDayOfWeek != -1");
        ...
        //                }
        //#endif
        //                Contract.Assert(this.calendarWeekRule != -1, "StarDateFormatInfo.CalendarWeekRule, calendarWeekRule != -1");
        ...
        **      concatation every time somebody uses this form
        ...
        private static string[] GetMergedPatterns(string[] patterns, string defaultPattern)
        {
            Contract.Assert(patterns != null && patterns.Length > 0,
                            "[StarDateFormatInfo.GetMergedPatterns]Expected array of at least one pattern");
            Contract.Assert(defaultPattern != null,
                            "[StarDateFormatInfo.GetMergedPatterns]Expected non null default string");
        ...
        public static StarDateFormatInfo ReadOnly(StarDateFormatInfo sdfi)
        {
            if (sdfi == null)
            {
            ...
            StarDateFormatInfo newInfo = (StarDateFormatInfo)(sdfi.MemberwiseClone());
            // We can use the data member calendar in the setter, instead of the property Calendar,
            // since the cloned copy should have the same state as the original copy.
            throw new NotImplementedException();
        ...
        // StarDateFormatInfo sdfi = new CultureInfo("ja-JP", false).StarDateFormat.Calendar = new JapaneseCalendar();
        // String nativeName = sdfi.NativeCalendarName; // Get the Japanese name for the Japanese calendar.
        // StarDateFormatInfo sdfi = new CultureInfo("ja-JP", false).StarDateFormat.Calendar = new GregorianCalendar(GregorianCalendarTypes.Localized);
        ...
        //
        // StarDateFormatInfo tokenizer.  This is used by StarDate.Parse() to break input string into tokens.
        //
        [NonSerialized]
        ...
        //
        //internal static StarDateFormatInfo GetJapaneseCalendarsdfi()
        //{
        //    StarDateFormatInfo temp = s_jajpsdfi;
        //    if (temp == null)
        //    {
        ...
        // */
        //internal static StarDateFormatInfo GetTaiwanCalendarsdfi()
        //{
        //    StarDateFormatInfo temp = s_zhtwsdfi;
        //    if (temp == null)
        //    {
        ...
        //            // StarDate.Parse behavior.  For instance, the StarDateFormatInfo.Tokenize() method might return SEP_DateOrOffset for KoreanHourSuff
        ...
        //                StarDateFormatInfo jasdfi = GetJapaneseCalendarsdfi();
        ...
        //        {
        //            StarDateFormatInfo twsdfi = GetTaiwanCalendarsdfi();
