...
def create_session():
    ...
    session.headers.update({
        'User-Agent': 'Chinese GEDCOM Repair Bot/1.0 (https://github.com/Immanuelle/Gaiad-Genealogy; immanuelle@example.com)'
    })
...
def main():
    print("Starting Chinese GEDCOM repair process...")
