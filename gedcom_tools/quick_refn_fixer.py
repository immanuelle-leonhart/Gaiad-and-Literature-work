...
def create_session():
    ...
    session.headers.update({
        'User-Agent': 'Quick REFN Fixer Bot/1.0 (https://github.com/Immanuelle/Gaiad-Genealogy; immanuelle@example.com)'
    })
...
def add_refn_statement(session, qid, refn_value, csrf_token):
    params = {
        ...
        'format': 'json',
        'token': csrf_token,
        'summary': 'Adding GEDCOM REFN from master genealogy'
    }
...
def main():
    print("Starting quick REFN fixer for I10000+ mappings...")
    
    # Load mappings for I10000+
    mappings = {}
    ...
    print(f"Found {len(mappings)} mappings for I10000+")
