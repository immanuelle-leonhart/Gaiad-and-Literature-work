#!/usr/bin/env python3
"""
JAPANESE FAMILY RELATIONSHIPS - FINAL VERSION
...
def create_session():
    ...
    session.headers.update({
        'User-Agent': 'Japanese Relationships Final/1.0 (https://github.com/Immanuelle/Gaiad-Genealogy; immanuelle@example.com)'
    })
